...
class IsotropicSphereModelTest : public Test
{
protected:
  ...
  grb::IsotropicSphereModel _model;
...
TEST_F(IsotropicSphereModelTest, init)
{
  ASSERT_EQ(grb::type::ISOTROPIC_SPHERE, _model.getType());
...
TEST_F(IsotropicSphereModelTest, ParseAnExecute_SetTime)
{
...
TEST_F(IsotropicSphereModelTest, ParseAnExecute_SetPhi)
{
...
TEST_F(IsotropicSphereModelTest, ParseAnExecute_SetTheta)
{
...
TEST_F(IsotropicSphereModelTest, ParseAnExecute_EmptyTokens)
{
  _tokens.clear();
  callParseAndExecute();
...
TEST_F(IsotropicSphereModelTest, ParseAnExecute_WrongRangeFormat)
{
  _cmd = grb::type::MODEL_SET_TIME;
  _tokens.clear();
...
TEST_F(IsotropicSphereModelTest, ParseAnExecute_UnhandledCommand)
{
  callParseAndExecute();
...
TEST_F(IsotropicSphereModelTest, ParseAnExecute_SetCatalogType_ValidType)
{
...
TEST_F(IsotropicSphereModelTest, ParseAnExecute_SetCatalogType_WrongType)
{
  _cmd = grb::type::MODEL_SET_CATALOG_TYPE;
  _tokens.clear();
...
TEST_F(IsotropicSphereModelTest, help)
{
  _model.help();
}

TEST_F(IsotropicSphereModelTest, generate_WrongCatalogTypeProvided)
{
...
TEST_F(IsotropicSphereModelTest, generate_CatalogEntryNotCreated)
{
...
TEST_F(IsotropicSphereModelTest, generate_WrongCatalogEntryCreated)
{
  grb::CatalogMock catalog(grb::type::GRBCAT);
...
*/
TEST_F(IsotropicSphereModelTest, generate_Positive)
{
  grb::CatalogMock catalog(grb::type::GRBCAT);
